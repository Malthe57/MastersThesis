...
def main_mimo(cfg):
    ...
    if naive:
        if is_resnet:
            ...
            model_name = 'C_NaiveWide/' + 'C_NaiveWide' + f'_{depth}_{widen_factor}_{n_subnetworks}_members'
        else:
        ...
        if is_resnet:
            ...
            model_name = f"C_MIMOWide/" + 'C_MIMOWide' + f'_{depth}_{widen_factor}_{n_subnetworks}_members'
